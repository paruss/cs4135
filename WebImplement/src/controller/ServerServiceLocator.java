...
public class ServerServiceLocator extends org.apache.axis.client.Service implements controller.ServerService {
    ...
    private java.lang.String Server_address = "http://localhost:8084/WebImplement/services/Server";
    ...
    public controller.Server getServer(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            controller.ServerSoapBindingStub _stub = new controller.ServerSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (controller.Server.class.isAssignableFrom(serviceEndpointInterface)) {
                controller.ServerSoapBindingStub _stub = new controller.ServerSoapBindingStub(new java.net.URL(Server_address), this);
                _stub.setPortName(getServerWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://controller", "ServerService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://controller", "Server"));
        }
